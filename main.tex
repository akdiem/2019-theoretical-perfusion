...
\title{A theoretical assessment of organ perfusion under large strain}
...
\author[1]{Alexandra K.~Diem PhD}
\author[2]{Kristian Valen-Sendstad PhD}

% Include full affiliation details for all authors
\affil[1]{Department of Computational Physiology, Simula Research Laboratory, Fornebu, Baerum, 1364, Norway}

\corraddress{Alexandra K.~Diem PhD, Department of Computational Physiology, Simula Research Laboratory, Fornebu, Baerum, 1364, Norway}
\corremail{alexandra@simula.no}

\fundinginfo{}

% Include the name of the author that should appear in the running header
\runningauthor{Alexandra K.~Diem et al.}
...
\begin{figure}[bt]
\centering
\includegraphics[width=6cm]{example-image-rectangle.png}
